...
### Client App
The Client App for Slates is just a simple webview to show the server's web UI. You have to enter IP Address or Personal Domain to access to the server. Anything that you need to use this app should be on your charge because I don't know your network envrionment settings. It might be simple if you do simple, but it will become harder if you do the hard things(like Multi-Hop VPN).
## +
